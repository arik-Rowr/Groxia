        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-10">
            ...
            <div>
              ...
              <ul className="space-y-3 text-[15px] text-gray-600">
                <li><Link href="/company/about" className="hover:text-blue-600 transition-colors">About Us</Link></li>
                <li><Link href="/company/contactus" className="hover:text-blue-600 transition-colors">Contact</Link></li>
